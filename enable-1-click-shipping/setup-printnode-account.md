...
![PrintNode icon in system tray](/images/printnode-icon-tray.png)
...
![Welcome to PrintNode](/images/welcome-to-printnode.png)
...
![PrintNode API Key in Parcelcraft](/images/printnode-api-key-in-parcelcraft.png)
...
![Select PrintNode Printers](/images/printnode-select-printers.png)

2. Select a printer for printing shipping labels and another printer for printing forms (if applicable).
3. Adjust the related settings — paper size, bin or tray, media type, DPI resolution, rotation, and fit to page — to match your printer. Only the settings your printer supports are shown.
...
> **Tip:** If you want to further automate your shipping workflow, consider [linking a digital scale](/docs/additional-automation/setup-a-digital-scale) to your Parcelcraft account. This will enable automatic weight capture and streamline the label creation process even more.
