...
Defaults for individual shipment options — Saturday delivery, custom label text, a return-label preference, and more — are set from the shipment itself rather than this page: see [Shipment options](/docs/full-page-app/shipment-options#set-defaults-for-future-shipments).
...
- **PRODUCT WEIGHT**: The weight of each individual product, as defined in the [Shippable products](/docs/enable-1-click-shipping/set-product-defaults) tab.
