...
3. If you haven't saved your SendGrid API Key, create a new key and ensure it is a Full Access Key or has access to Design Library, Address Allow List, BCC, Suppressions, Unsubscribe Groups, Email Testing, and Mail Send. Copy the API key into a document to make sure you have copied it correctly.
...
In SendGrid, add a verified sender, create an unsubscribe group, and create a dynamic template for each of the customer shipping notification, canceled shipment notification, and return shipment notification:
...
SendGrid allows you to use special variables in your emails using Handlebars. Variables are enclosed in double curly braces like `{{my_variable}}`. Read about how to use [Handlebars variables](https://docs.sendgrid.com/for-developers/sending-email/using-handlebars) in your dynamic email templates.


##### Compose a SendGrid dynamic template

![SendGrid Dynamic Templates](/images/sendgrid-shipment-notification.png)
...
You can test your variables in your SendGrid Preview by using this test data. All email notifications will receive a similar payload to this. In SendGrid on your Template view, click 'Preview' and enter this test data:
...
![SendGrid Dynamic Templates](/images/sendgrid-shipment-notification-test-data.png)
