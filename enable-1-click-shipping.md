...
![1-click ship button](/images/1-click-ship-button.png)

> **Note:** 1-click shipping is available only in the [drawer](/docs/full-page-app)
> (the compact side panel), due to a Stripe SDK limitation. If you work in the
> [full-page app](/docs/full-page-app), use [bulk shipping](/docs/full-page-app/bulk-shipping)
> as the high-volume equivalent.
