...
4. Add an origin address in your [Parcelcraft settings](https://dashboard.stripe.com/settings/apps/com.productivity.parcelcraft).


That's it! You've set up Parcelcraft Shipping. You can now [print test labels](/docs/getting-started/print-test-label).

## Where you'll work

Parcelcraft runs in two places inside the Stripe dashboard: the
[full-page app](/docs/full-page-app) — a dedicated page with the unified Orders
list, shipment history, and [bulk shipping](/docs/full-page-app/bulk-shipping) —
and the drawer, a compact side panel that opens on top of any dashboard page.
Both offer the same functionality; the full page is the roomier place to work
through many orders at once. Read
[The full-page app](/docs/full-page-app) to learn how to open each surface.

> Having trouble finding your EasyPost API key?  Read our more detailed [EasyPost connection guide](/docs/getting-started/connect-easypost).
