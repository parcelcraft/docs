...
- Fixed: International shipment would have an auto-generated customs explanation based on the array of products in the shipment, which would sometimes exceed the 255 character limit.  The customs explanation is not truncated to 255 characters by default. We now show the customs explanation by default.
