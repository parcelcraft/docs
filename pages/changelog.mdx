...
- Fixed: Users who use centimeters as a default measurement unit were presented package measurements in inches (In the background EasyPost only acccepts package measurement units in inches, and the app failed to correct the user dimension unit preference when displayed)
