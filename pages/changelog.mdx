...
---
## 2.1.0 <span style={{fontSize: "16px"}}>August 17, 2026</span>
...
- Label images failed to load on the print page because the label URL was built from the old dashboard host.
...
- In the orders table, Refunded showed as a neutral badge and Partially refunded never matched at all.
...
- Orders table defaults reordered (currency and description promoted), and redundant column headers hidden.
- Toolbar on the Orders page restyled — Create shipment is now the primary action.
- Label buttons use sentence case: "Buy 3 labels", "Print 2 test labels".
...
---
## 2.0.5 <span style={{fontSize: "16px"}}>August 13, 2026</span>

- Fixed: Links from FullPage app to dashboard were not opening the app drawer
- Fixed: Estimated weight was not calculated properly based on the fallback weight defaults products and shipping rates.
- Fixed: We now display the weight default settings the user chose in the packing list for each product and shipping rate
- Fixed: Hazmat options for FedEx shipments now use FedEx's updated Hazmat classifications
- Added: Error warning when attempting to edit a checkout-session generated Shipping Rate -- these rates can not be edited.

---
## 2.0.1 <span style={{fontSize: "16px"}}>August 12, 2026</span>
...
---
## 1.7.0 <span style={{fontSize: "16px"}}>April 14, 2026</span>
...
---
## 1.6.0 <span style={{fontSize: "16px"}}>March 3, 2026</span>
...
---
## 1.5.4 <span style={{fontSize: "16px"}}>November 26, 2025</span>
...
---
## 1.4.3 <span style={{fontSize: "16px"}}>October 10, 2025</span>
...
---
## 1.4.1 <span style={{fontSize: "16px"}}>August 19, 2025</span>
...
---
## 1.3.8 <span style={{fontSize: "16px"}}>June 24, 2025</span>
...
---
## 1.3.7 <span style={{fontSize: "16px"}}>June 18, 2025</span>
...
---
## 1.3.6  <span style={{fontSize: "16px"}}>June 2, 2025</span>
