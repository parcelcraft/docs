...
In this tutorial, we will guide you through the process of manually creating an international shipping label using Parcelcraft. Typically, most of the information entered during this tutorial would be automatically populated from the invoice and defaults set up in the [Enable 1-Click Shipping](/enable-1-click-shipping) and [International Shipping](/international-shipping) sections.
