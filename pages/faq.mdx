...
A: When an invoice is created, our Parcelcraft server will investigate if an invoice is shippable. 1) If there is a shipping rate attached to the invoice it will appear in your unshippped invoice list. 2) If any product in your invoice is shippable it will appear in your unshipped invoice list. 
