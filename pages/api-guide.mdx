...
| package_code | <span className="code">Letter</span> | The package code for your EasyPost carrier. Defaults to <span className="code">**Package**</span> ee https://www.easypost.com/carriers   | 
