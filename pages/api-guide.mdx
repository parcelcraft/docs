...
| package_code | <span className="code">Letter</span> (The package code for your EasyPost carrier. Defaults to <span className="code">**Package**</span>)  | 
| packaging_weight | <span className="code">.26</span> |
...
| service_code | <span className="code">FirstClassMailInternational</span> (The compatible service code for your EasyPost carrier) |
| width | <span className="code">10</span> The default packaging width for this shipping rate (in the dimension unit as set in your settings, defaults to inch) |
| length | <span className="code">5</span> The default packaging length for this shipping rate (in the dimension unit as set in your settings, defaults to inch) |
| height | <span className="code">8</span> The default packaging height for this shipping rate (in the dimension unit as set in your settings, defaults to inch) |

## Stripe Customer metadata

- Some addresses (for example shared office spaces) may require a company name for a successful shipment. 
- If your Stripe customer record has a <span className="code">company</span> metadata value, we'll automatically add that to the customer's shipping address when you create a shipment.
