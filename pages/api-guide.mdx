...
Tip: ask for a company name with a custom field in your checkout flow.  Some addresses (for example shared office spaces) may require a company name for a successful shipment.
