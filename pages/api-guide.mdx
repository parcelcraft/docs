...
| ship_date | **2024-05-24T18:07:34Z** |
 | ship_status | **shipped** (Could be value of unshipped, cancelled, back_ordered.  The ship_status metadata will not exist if invoice or payment is considered to be non-shippable) |
...
| weight | 0.44 |
| weight_unit | Either <span className="code">**gram**</span>, <span className="code">**ounce**</span>, <span className="code">**pound**</span>, or <span className="code">**kilogram**</span>.  Defaults to ounces |
...
| packaging_weight | | .26 |
| packaging_weight_unit | Either <span className="code">**gram**</span>, <span className="code">**ounce**</span>, <span className="code">**pound**</span>, or <span className="code">**kilogram**</span>.  Defaults to ounces |
