...
## Shipping features
- [The full-page app](/full-page-app): Work from the unified Orders list, shipment history, wallet, pickups, and end-of-day forms in the Stripe dashboard.
- [Bulk shipping](/full-page-app/bulk-shipping): Select many orders and buy all their labels in one batch.
- [Shipment options](/full-page-app/shipment-options): Carrier-aware options, third-party billing, and per-option defaults.
...
- [Set up a digital scale](/additional-automation/setup-a-digital-scale): Learn how to connect a digital scale for automatic weight capture.
