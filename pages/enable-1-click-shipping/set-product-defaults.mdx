...
In the Parcelcraft settings, navigate to the **Shippable products** tab to view a list of all the products you have defined in Stripe. To ensure a product appears in your unshipped orders list whenever an order is placed, enable the "Shippable" option for that product.
