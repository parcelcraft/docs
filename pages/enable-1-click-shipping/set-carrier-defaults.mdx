...
Defaults for individual shipment options — Saturday delivery, custom label text, a return-label preference, and more — are set from the shipment itself rather than this page: see [Shipment options](/full-page-app/shipment-options#set-defaults-for-future-shipments).
