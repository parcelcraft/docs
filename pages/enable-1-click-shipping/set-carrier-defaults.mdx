...
- **PRODUCT WEIGHT**: The weight of each individual product, as defined in the [Shippable Products](/shippable-products) settings.
- **PRODUCT QUANTITY**: The number of units of each product included in the shipment.
- **PACKAGING WEIGHT**: The weight of the packaging materials used to ship the products, as specified in the [Packaging](/packaging) settings.
