...
![1-click ship button](./../public/images/1-click-ship-button.png) 

> **Note:** 1-click shipping is available only in the [drawer](/full-page-app)
> (the compact side panel), due to a Stripe SDK limitation. If you work in the
> [full-page app](/full-page-app), use [bulk shipping](/full-page-app/bulk-shipping)
