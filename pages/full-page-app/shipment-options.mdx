...
[Create shipment view](/full-page-app/create-shipment), just below the package
...
![The expanded shipment options list](./../../public/images/v2/create-shipment-set-shipment-options.png)
...
Stripe record. See [Tax identifiers](/international-shipping/tax-identifiers).
...
![Third-party billing fields](./../../public/images/v2/options-3rd-party-billing.png)
...
![Setting a default from an option's gear menu](./../../public/images/v2/create-shipment-options-set-defaults-for-future-shipments.png)
...
[Carrier defaults](/enable-1-click-shipping/set-carrier-defaults).
