...
Every shipment — single, [bulk](/full-page-app/bulk-shipping), or blank —
is created in the same **Create shipment** view. You can open it from anywhere you see an order:

- In the [Orders list](/full-page-app/orders-list), click a row or its
...
![Configure a single shipment](./../../public/images/v2/create-shipment-configure-single-shipment.png)
...
- **Return label** and **Saturday delivery** toggles sit below the package,
  ...
  [Shipment options](/full-page-app/shipment-options) for the full list,
...
![Package validation errors and warnings](./../../public/images/v2/create-shipment-inline-error-states.png)
...
[International shipping](/international-shipping) for details.
...
![The Print label tab after purchase](./../../public/images/v2/create-shipment-print-shipment.png)
...
- **Add insurance** — the amount is prefilled from the order total;
  ...
  [Insurance](/full-page-app/insurance).
...
- Confirm the **tracking email** — for test labels, a preview of the
  ...
  customer.
- Schedule a [driver pickup](/full-page-app/pickups) so the carrier
