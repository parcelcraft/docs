...
The **Create shipment** tab of the [full-page app](/full-page-app) shows a
...
- Click any row (or its **Create shipment** button) to open the shipment and
  [buy a label](/full-page-app/create-shipment).
- Select multiple orders to
  [create shipments in bulk](/full-page-app/bulk-shipping).
...
- **Products** — show only orders containing specific products. Search for
  ...
  ![Filter orders by product](./../../public/images/v2/Filter-by-product.png)
...
- **Timeframe** — show orders from the last 7, 30, or 90 days, the last 6
  ...
  ![Filter orders by timeframe and force a new order sync](./../../public/images/v2/filter-orders-by-time-frame-and-resync.png)
...
tracking emails, [add insurance](/full-page-app/insurance), request a
[driver pickup](/full-page-app/pickups), and manage or void existing
shipments.

![The Shipment history tab in the full-page app](./../../public/images/v2/full-page-shipment-history-tab.png)
