...
- Click **Pickups** at the top of the [full-page app](/full-page-app), or in
...
![Select shipments for pickup](./../../public/images/v2/pickups-step1-select-shipments.png)
...
![Schedule the driver pickup](./../../public/images/v2/pickups-step2-schedule.png)
...
> [end-of-day scan form](/full-page-app/end-of-day) lets them accept the
