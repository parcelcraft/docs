...
flow. Select the orders in the [Orders list](/full-page-app/orders-list),
...
[1-click shipping](/enable-1-click-shipping) for high-volume days.
...
![Select multiple orders and create shipments in bulk](./../../public/images/v2/create-shipment-bulk-shipment.png)
...
[single shipment](/full-page-app/create-shipment) is: the recipient from the
...
![Get quotes from all carriers and select rates](./../../public/images/v2/create-shipment-get-a-quote-with-all-carriers.png)
...
![The Review customs step for a batch](./../../public/images/v2/create-shipment-customs-tab.png)
...
[International shipping](/international-shipping) for the details of each
field.
...
- **Add insurance to all shipments**
  [insures every label](/full-page-app/insurance) in one click, with each
...
[driver pickup](/full-page-app/pickups) or hand your driver an
[end-of-day scan form](/full-page-app/end-of-day) so the whole batch is
