...
To enable 1-click shipping, you'll need to configure a few default settings. These default settings are optional and can be changed at any point when you're creating a label.
