...
3. If you don't have a test API key, click on *Add additional key** on your  [EasyPost API Keys tab on the Account Settings page](https://www.easypost.com/account/settings?tab=api-keys).
