...
To use Parcelcraft for shipping, you need to integrate it with an EasyPost account. EasyPost provides access to multiple shipping carriers and automates payments to the carriers. Follow the steps below to set up your EasyPost account and connect it to Parcelcraft.
