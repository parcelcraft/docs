...
After [creating and configuring your EasyPost account](/getting-started/setup-easypost), you can easily connect it to your Parcelcraft account to start managing your shipments. Follow these simple steps to establish the connection:
...
1. Log in to your Parcelcraft account and go to the [Settings page](https://dashboard.stripe.com/settings/apps/com.productivity.parcelcraft).
