...
## Step 2: Obtain Your EasyPost Production API Key
...
1. Log in to your EasyPost account and navigate to the [EasyPost API Keys tab on the Account Settings page](https://www.easypost.com/account/settings?tab=api-keys).
   ...
   > **Note**: <span style={{color: "darkred"}}>**If you DO NOT see an API keys tab**</span> in EasyPost, you'll need to contact [EasyPost Support](https://support.easypost.com/hc/en-us/requests/new) to ask them to enable your account for API Keys 
...
3. If you are lacking a test key, Click on Add key on your  [EasyPost API Keys tab on the Account Settings page](https://www.easypost.com/account/settings?tab=api-keys).
...
## Step 3: Enter Your EasyPost API Key in Parcelcraft
...
3. Paste the Production API key you copied from EasyPost into the provided box.  Even in Stripe Test mode, you must enter a **Production API** key into the Parcelcraft settings.
   ...
   > Note:  If you have both a test and production key in your EasyPost account, your EasyPost Test API key will be auto filled.  Click the refresh button if you need to add or change Test API Key in your EasyPost account.
...
## Step 4: Access Your EasyPost Billing Settings
