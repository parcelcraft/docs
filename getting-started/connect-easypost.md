...
3. Paste the Production API key you copied from EasyPost into the provided box.  Even in Stripe Test mode, you must enter a **Production API key** into the Parcelcraft settings.
   ...
   ![EasyPost API Key in Parcelcraft](/images/parcelcraft-test-and-production-keys.png)

   > Note:  If you have both a **test** and a **production** key in your EasyPost account, your EasyPost Test API key will be auto-filled.  Click the refresh button next to your EasyPost Test API Key if you need to add or change your Test API Key in your EasyPost account.
...
- **Credit Card**: Funds your account immediately, allowing you to start shipping. However, it incurs a 3.75% processing fee.
...
You'll need sufficient funds in your EasyPost account before you can start generating shipping labels through Parcelcraft.
